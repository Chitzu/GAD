...
clf = neural_network.MLPClassifier(hidden_layer_sizes=70, learning_rate_init=0.01)
...
clf = neural_network.MLPClassifier(hidden_layer_sizes=(70, 35), learning_rate_init=0.01)
clf.fit(data_train, etichete_train)
...
clf = neural_network.MLPClassifier(hidden_layer_sizes=(70, 70), learning_rate_init=0.1)
clf.fit(data_train, etichete_train)
